# Full Stack Web Development & Animation Tools

This list compiles modern full-stack web development tools for creating professional, visually rich, animation-heavy websites.
...
- [npm](https://nodejs.org/api/all.html)
- [pnpm](https://pnpm.io)
...
- [dotLottie Player](https://developers.lottiefiles.com/docs/dotlottie-player/dotlottie-web/)
- [Swup](https://swup.js.org/getting-started)
- [Barba.js](https://barba.js.org/docs/getstarted/)

---

## 🧱 WebGL / 3D / Shader Libraries
...
- [FFmpeg.wasm](https://ffmpegwasm.netlify.app/docs)
...
- [Model Context Protocol Docs](https://modelcontextprotocol.info/docs/)
- [Anthropic MCP Overview](https://docs.claude.com/en/docs/mcp)
